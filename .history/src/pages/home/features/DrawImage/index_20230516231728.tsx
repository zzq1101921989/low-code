  ...
  useEffect(() => {
    ...
    const readerFile = (e: any) => {
      ...
      if (image) {
        ...
        const clientWidth = pendingUplaodBox.current!.clientWidth
        const clientHeight = pendingUplaodBox.current!.clientHeight
        

        // 显示图片
        image.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', urlData);
        ...
        pendingUplaodBox.current.style.width = clientWidth + 'px'
        pendingUplaodBox.current.style.height = clientHeight + 'px'
