...
const contaienrWidth = 800

const contianerHeight = 800

const containerMaxWidthItemNumber = 4

const containerMaxHeightItemNumber = 4

const itemOneWidth = contaienrWidth / containerMaxWidthItemNumber
const itemOneHeight = contianerHeight / containerMaxHeightItemNumber
  ...
  useEffect(() => {
    ...
    const readerFile = (e: any) => {
      ...
      if (image) {
        ...
        (container.parentNode as HTMLElement)!.style.height = clientHeight + "px";
      }
  ...
  return (
    ...
    >
      <Row gutter={[16, 16]} style={{ height: "100%" }}>
        <Col span={24}>
          <ItemBox areaHeight={2 * itemOneWidth} dataIndex={itemIndex} activeIndex={activeBoxIndex} />
        </Col>
        <Col span={24}>
          <Row gutter={[16, 16]} style={{ height: "100%" }}>
            <Col span={12}>
