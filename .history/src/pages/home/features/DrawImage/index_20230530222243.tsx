    ...
    layout.forEach((lay) => {
      ...
      if (children && direction) {
        ...
        children.forEach((child) => {
          ...
          const { dirH, dirW, type, direction, children: childs } = child;
          ...
          if (!direction) {
            ...
            elements = elements.concat(handlerLayout(childs, currentWidth, currentHeight))
          }

          // 占据宽度高度更新
          occupyWidth += currentWidth;
          if (direction === "top") occupyHeight += currentHeight;
