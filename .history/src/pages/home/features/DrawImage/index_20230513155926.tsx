      ...
      ele.current.addEventListener("mousedown", (e) => {
        if (e.target && (e.button === 0 || e.button === 2) ) {
          ...
          if (type === 'add') {
            ...
            console.log(ele.current?.offsetLeft, 'ele.current?.offsetLeft');
            console.log((ele.current?.parentNode as HTMLElement | null)?.offsetLeft, 'ele.current.parentNode.offsetLeft');
