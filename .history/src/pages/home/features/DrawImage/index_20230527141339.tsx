...
const DrawImage: FC<DrawImageProps> = (props) => {
   ...
   * @param {LayoutConfig[]} positions 矩形的配置
   * @param {any} config.left 左边距
   * @param {any} config.top 上边距
   * @param {any} config.width 宽度
   * @param {any} config.height 高度
   * @param {any} config.padding 间距
   */
