...
const ItemBox: FC<ItemBoxProps> = (props) => {
  ...
  return (
    <div className={styles.itemBox} style={{ border: `2px ${activeIndex ===  dataIndex? 'solid #2354f4' : 'dashed #1e80ff80'}` }}>
      ...
      <span className={styles.add} data-type="add" data-index={dataIndex}>
        +
      </span>
    </div>
  );
