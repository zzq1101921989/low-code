...
const ItemBox: FC<ItemBoxProps> = (props) => {
  const { isActive, dataIndex } = props;

  console.log(dataIndex, 'dataIndex');
  

  return (
    <div className={styles.itemBox} style={{ border: `2px ${isActive ? 'solid #2354f4' : 'dashed #1e80ff80'}` }}>
      ...
      <span className={styles.add} data-type="add">
        +
      </span>
    </div>
  );
