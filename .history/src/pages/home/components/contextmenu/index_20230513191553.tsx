...
const ContextMenu: FC<ContextMenuProps> = (props) => {
  ...
  return (
    <div className={styles.contextMenu} style={{left, top, display: open ? 'block' : 'none'}}>
      <div className={styles.contextMenuItem} id='uploadBtn'>
        <Space>
          <svg
      ...
      <input ref={fileRef} type="file" id="cellImgPicker" accept="image/jpeg,image/png" style={{display: 'none'}} />
    </div>
  );
};
